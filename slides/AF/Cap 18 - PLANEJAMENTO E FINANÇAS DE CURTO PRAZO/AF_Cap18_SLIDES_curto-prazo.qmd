...
![Linha do tempo dos fluxos de caixa e atividades operacionais de curto prazo](figs/timeline-ciclos.png){fig-align="center"}

- O **Ciclo Operacional** abrange desde a Compra de Estoque até a Entrada de Caixa das Vendas.
- O **Ciclo Financeiro** inicia na Saída de Caixa (pagamento de estoque) e termina na Entrada de Caixa (recebimento das vendas).
