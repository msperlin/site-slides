...
#  {background-image="figs/Lojas-Americanas.png"}

## Introdução

> O caso das Americanas (2023) é a maior fraude do mercado brasileiro, envolvendo valores perto de R$ 43 bilhões.
...
- Se existe um banco financiando a operação, a dívida deixa de ser com o "fornecedor" e passa a ser uma dívida bancária. Como tal, ela deveria gerar despesas de juros e aparecer no passivo financeiro, aumentando o endividamento da empresa.
:::
...
## O preço das ações (valor societário)
