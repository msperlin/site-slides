...
5. Instale o pacote `GetTDData` no seu computador. Leia o manual do pacote e utilize a função `GetTDData::get.yield.curve()` para baixar a curva de juros atual no sistema financeiro Brasileiro.
